...
class Version220210704052121 extends Version
{
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Наличие_чекбокс',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'EXISTENCE_CHECKBOX',
  'DEFAULT_VALUE' => NULL,
  'PROPERTY_TYPE' => 'E',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        4 => 'ID',
        5 => 'PROPERTY_AUTOR',
        6 => 'PROPERTY_NAME_BOOK',
        7 => 'PROPERTY_EXISTENCE',
        8 => 'PROPERTY_EXISTENCE_CHECKBOX',
        9 => 'PROPERTY_PRICE',
      ),
      'columns_sizes' => 
      array (
